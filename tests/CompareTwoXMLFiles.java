...
public class CompareTwoXMLFiles
{
...
//	 List <String> l = new ArrayList<>();
	 public CompareTwoXMLFiles() {
		// boolean x = diff(xml1,xml2,l);
		}


	public boolean diff( String xml1, String xml2, List<String> diffs ) throws Exception
    {
		//xml1 = "C:\\Users\\satya.chintala\\Automation\\SFDC-ECRM\\SFDC-ECRM\\src\\test\\java\\com\\ecrm\\testdata\\unpackaged\\profiles\\SatyaTesting1.profile";
		//xml2 = "C:\\Users\\satya.chintala\\Automation\\SFDC-ECRM\\SFDC-ECRM\\src\\test\\java\\com\\ecrm\\testdata\\unpackaged\\profiles\\SatyaTesting.profile";
    ...
    {
        //Sort by Name
        Map<String,Node> children1 = new LinkedHashMap<>();
        ...
        //Sort by Name
        Map<String,Node> children2 = new LinkedHashMap<>();
    ...
    public boolean diffAttributes( Node node1, Node node2, List<String> diffs ) throws Exception
    {
        ...
        Map<String,Node> attributes1 = new LinkedHashMap<>();
        ...
        Map<String,Node> attributes2 = new LinkedHashMap<>();
